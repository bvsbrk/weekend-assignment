...
class UserMainCode15 {
    ...
    public static TreeMap<Integer, Integer> calculateRevisedSalary(Map<Integer, String> dob, Map<Integer, Integer> salary) {
        ...
        for (int empId: dob.keySet()) {
            ...
            if (salC && ageC) map.put(empId, -100);
            else if (salC) map.put(empId, -100);
            else if (ageC) map.put(empId, -200);
        }
        return map;
    }
